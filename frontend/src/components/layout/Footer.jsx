      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-[#7A8F7C] mb-6">
              Sourcing premium quality dry fruits directly from the finest farms.
              Bringing nature's best to your doorstep since 2005.
            </p>
            <div className="flex gap-3">
              {[
                { icon: <WhatsAppIcon />,  href: "https://wa.me/918104956871",                 label: "WhatsApp" },
                { icon: <InstagramIcon />, href: "https://instagram.com/karunfruits",          label: "Instagram" },
                { icon: <FacebookIcon />,  href: "https://facebook.com/karunfruits",           label: "Facebook" },
                { icon: <Tv className="w-4 h-4" />, href: "https://youtube.com/@karunfruits", label: "YouTube" },
              ].map((s) => (
                <a
                  key={s.label}
                  href={s.href}
                  ...
                  rel="noreferrer"
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full border border-[#2A3A2C] flex items-center justify-center text-[#7A8F7C] hover:border-[#C17A35] hover:text-[#C17A35] transition-all"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {/* Categories */}
          <div>
            <h3 className="label-luxury text-[#C17A35] mb-5">Our Range</h3>
          ...
          {/* Quick links */}
          <div>
            <h3 className="label-luxury text-[#C17A35] mb-5">Quick Links</h3>
            <ul className="space-y-2.5">
              {QUICK_LINKS.map((l) => (
                <li key={l.to}>
          ...
          {/* Contact */}
          <div>
            <h3 className="label-luxury text-[#C17A35] mb-5">Contact Us</h3>
            <ul className="space-y-4">
              <li className="flex gap-3">
                <MapPin className="w-4 h-4 text-[#C17A35] mt-0.5 flex-shrink-0" />
                <span className="text-sm text-[#7A8F7C] leading-relaxed">
                  Shop No.46, Gaumukh Bhavan,<br />
                  Yusuf Meher Ali Rd, Bhat Bazar,<br />
                  Masjid Bandar, Mumbai – 400009
                </span>
              </li>
              <li className="flex gap-3 items-center">
                <Phone className="w-4 h-4 text-[#C17A35] flex-shrink-0" />
                <a href="tel:+918104956871" className="text-sm text-[#7A8F7C] hover:text-[#F5F0E8] transition-colors">
                  +91 81049 56871
                </a>
              </li>
              <li className="flex gap-3 items-center">
                <Mail className="w-4 h-4 text-[#C17A35] flex-shrink-0" />
                <a href="mailto:hello@karunfruits.com" className="text-sm text-[#7A8F7C] hover:text-[#F5F0E8] transition-colors">
                  hello@karunfruits.com
                </a>
              </li>
            </ul>
